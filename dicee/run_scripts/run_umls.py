...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\UMLS_Tokenizer_Path\tokenizer.json"
    model = ["DistMult", "ComplEx", "QMult", "Keci"]
    dataset_path = ["..\\KGs\\UMLS"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_UMLS"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_UMLS.txt", "w") as log:
