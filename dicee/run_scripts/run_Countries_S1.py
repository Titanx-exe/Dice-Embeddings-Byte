...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\Countries_S1_Tokenizer_Path\tokenizer.json"
    ...
    results = []
    eval_dir = "Final_Results_Countries_S1"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_Countries_S1.txt", "w") as log:
