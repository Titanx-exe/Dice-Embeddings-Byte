...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\WN18RR_Tokenizer_Path\tokenizer.json"
    model = ["DistMult", "ComplEx", "QMult", "Keci"]
    dataset_path = ["..\\KGs\\WN18RR"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_WN18RR"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_WN18RR.txt", "w") as log:
