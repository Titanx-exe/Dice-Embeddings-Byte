...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\FB15k_237_Tokenizer_Path\tokenizer.json"
    model = ["DistMult", "ComplEx", "QMult", "Keci"]
    dataset_path = ["..\\KGs\\FB15k-237"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_FB15k_237"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_FB15k_237.txt", "w") as log:
