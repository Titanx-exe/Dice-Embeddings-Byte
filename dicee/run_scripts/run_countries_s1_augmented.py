...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = "../Tokenizer/Countries_S1_Augmented_10_Tokenizer_Path/tokenizer.json"
    ...
    dataset_path = ["../KGs/Countries_S1_Augmented_10"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_Countries_S1_Augmented_10_CTA"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_Countries_S1_Augmented_10_CTA.txt", "w") as log:
