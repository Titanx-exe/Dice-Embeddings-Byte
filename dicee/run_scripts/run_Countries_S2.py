...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\Countries_S2_Tokenizer_Path\tokenizer.json"
    model = ["DistMult", "ComplEx", "QMult", "Keci"]
    dataset_path = ["..\\KGs\\Countries-S2"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_Countries_S2"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_Countries_S2.txt", "w") as log:
