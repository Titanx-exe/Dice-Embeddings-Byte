...
if __name__ == "__main__":
    ...
    # custom_tokenizer_path = "../Tokenizer/NELL_995_h100_Augmented_5_Tokenizer_Path/tokenizer.json"
    # custom_tokenizer_path = "../Tokenizer/NELL_995_h100_Augmented_10_Tokenizer_Path/tokenizer.json"
    custom_tokenizer_path = None
    model = ["DistMult", "ComplEx", "QMult", "Keci"]
    dataset_path = ["../KGs/NELL_995_h100_Augmented_5"]
    # dataset_path = ["../KGs/NELL_995_h100_Augmented_10"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_NELL_995_h100_Augmented_5_no_byte"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_NELL_995_h100_Augmented_5_no_byte.txt", "w") as log:
