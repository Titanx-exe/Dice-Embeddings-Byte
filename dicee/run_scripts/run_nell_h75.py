...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\NELL_995_h75_Tokenizer_Path\tokenizer.json"
    model = ["DistMult", "ComplEx", "QMult", "Keci"]
    dataset_path = ["..\\KGs\\NELL-995-h75"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_NELL995_h75"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_NELL995_h75.txt", "w") as log:
