...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\NELL_995_h100_Tokenizer_Path\tokenizer.json"
    ...
    results = []
    eval_dir = "Final_Results_NELL995_h100"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_NELL995_h100.txt", "w") as log:
