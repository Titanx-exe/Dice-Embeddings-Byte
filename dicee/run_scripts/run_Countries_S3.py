...
if __name__ == "__main__":
    ...
    custom_tokenizer_path = r"..\Tokenizer\Countries_S3_Tokenizer_Path\tokenizer.json"
    model = ["DistMult", "ComplEx", "QMult", "Keci"]
    dataset_path = ["..\\KGs\\Countries-S3"]
    embed_dim = [32, 64]
    ...
    results = []
    eval_dir = "Final_Results_Countries_S3"
    os.makedirs(eval_dir, exist_ok=True)

    with open("grid_search_results_Countries_S3.txt", "w") as log:
